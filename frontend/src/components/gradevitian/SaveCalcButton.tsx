...
/** Appears inside a ResultCard when the user is logged in. Persists the calculation
...
export default function SaveCalcButton({
  ...
  return (
    <button
      ...
      className="mt-3 inline-flex items-center gap-1.5 rounded-md border border-current/30 px-2.5 py-1 text-xs font-medium opacity-80 transition hover:opacity-100 disabled:opacity-60"
    >
