...
tech: [Next.js 16, FastAPI, ChromaDB, Gemini 2.5 Flash, BAAI/bge-base-en-v1.5, HyDE, BM25, Knowledge Graph, SQLite, SlowAPI, AWS Lightsail, Nginx, S3, GitHub Pages, GitHub Actions]
links:
  - label: GitHub
...
│  │  quotes.json · lab.json (auto-regenerated from content.db)       │   │
│  │  blog.json   (auto-regenerated from content.db)                  │   │
│  └──────────────────────────────────────────────────────────────────┘   │
└──────────────────────────────────────────────────────────────────────────┘
                  │
                  │  Google AI API  (HTTPS)
...
1. Regenerates the corresponding JSON file (`blog.json` or `lab.json`) in `backend/data/knowledge/`
